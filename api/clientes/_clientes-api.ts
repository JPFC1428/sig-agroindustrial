...
type ClienteEstadoValue = "activo" | "inactivo" | "suspendido";
type TipoClienteValue = "empresa" | "persona";

type ClienteApiRecord = {
  id: string;
  nombre: string;
  empresa: string;
  email: string;
...
const CLIENTES_API_LOG_PREFIX = "[api/clientes/_clientes-api]";
