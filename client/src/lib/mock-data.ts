...
export const visitasMock: Visita[] = [
  {
    ...
    hora: '10:00',
    objetivo: 'Revisar avance comercial y definir siguientes oportunidades de venta',
    resultado: 'Cliente interesado en incrementar pedidos. PrÃ³ximo pedido estimado: 50 sacos',
    observaciones: 'Cliente muy satisfecho con calidad actual',
    estado: VisitaEstado.REALIZADA,
    duracion: 45,
  ...
  },
  {
    ...
    hora: '14:30',
    objetivo: 'Negociar condiciones especiales para compras de mayor volumen',
    resultado: 'Se negociaron precios especiales para volÃºmenes mayores a 100 sacos',
    observaciones: 'Pendiente formalizar propuesta comercial',
    estado: VisitaEstado.REALIZADA,
    duracion: 60,
  ...
  },
  {
    ...
    hora: '09:00',
    objetivo: 'Presentar portafolio inicial y validar interÃ©s del prospecto',
    resultado: 'Prospecto muy receptivo. SolicitÃ³ muestras de 3 variedades diferentes',
    observaciones: 'Buena disposiciÃ³n para recibir cotizaciÃ³n posterior',
    estado: VisitaEstado.REALIZADA,
    duracion: 50,
...
export const seguimientosMock: Seguimiento[] = [
  {
    ...
    fechaVencimiento: new Date('2026-03-15'),
    observaciones: 'Confirmar decision sobre descuento adicional solicitado',
    estado: SeguimientoEstado.PENDIENTE,
    relacionadoNombre: 'Juan Carlos Rodriguez',
    relacionadoEmpresa: 'Cafe Premium Colombia S.A.S.',
  ...
  },
  {
    ...
    fechaVencimiento: new Date('2026-03-12'),
    observaciones: 'Seguimiento posterior para confirmar recepcion de muestras',
    estado: SeguimientoEstado.CERRADO,
    relacionadoNombre: 'Roberto Sanchez',
    relacionadoEmpresa: 'Cafe Artesanal Colombiano',
    fecha: new Date('2026-03-12'),
  ...
  },
  {
    ...
    observaciones: 'Preparar propuesta final antes de reunion de cierre',
    estado: SeguimientoEstado.EN_PROCESO,
    relacionadoNombre: 'Luis Fernando Diaz',
    relacionadoEmpresa: 'Cooperativa Caficultores Unidos',
